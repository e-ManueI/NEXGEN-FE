...
interface BasePredictionPlaygroundProps {
  defaultRole: UserType;
  /** when true, call refreshPredictions() on successful submit */
  refreshOnSuccess?: boolean;
}
export default function BasePredictionPlayground({
  defaultRole,
  refreshOnSuccess = false,
}: BasePredictionPlaygroundProps) {
  ...
  const { generateAnalysis, isGenerating, generateError } = useGenerateAnalysis(
    {
      role: (session?.user?.role as UserType) || defaultRole,
    },
  );
                        ...
                        <Button
                          ...
                          onClick={() =>
                            adjustValue(
                              ...
                              constrainedUpdateBrineComposition,
                              key as keyof BrineComposition,
                              true, // or `false` for minus button
                            )
                          }
                        >
